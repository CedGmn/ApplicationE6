...
import com.example.myapplication.requestRegister.MyRequest;
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (pseudo.length() > 0 && email.length() > 0 && password.length() > 0 && password2.length() > 0) {
                    ...
                    Toast.makeText(getApplicationContext(), "Veulliez remplir tous les champs" , Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
